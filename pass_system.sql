...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 26 2022 г., 04:24
...
(44, 61, 'A123AA', '', '2022-01-27 06:12:00', '', 'Иванова Иван Иванович', '0', '', 'Ожидается', NULL),
(45, 60, 'Г999ГВ', '', '2022-01-29 06:13:00', '', 'Серый Сергей Сергеевич', '0', '', 'Ожидается', NULL);
...
('Иванов Иван Иванович', '79812311223', 'Ул. Красная д.10 кв. 55', 13, 533873246, NULL),
('Козлов Даниил Анатольевич ', '79027220728', '1 ', 19, 865231654, NULL),
('Евгений', '79654321111', 'Ул Длинная дом 10 кв 60', 59, 214748364, NULL),
('Васильев Владимир Викторович', '78945612345', 'Ул Длинная дом 12 кв 11', 60, 83523165, NULL),
('Охрана', '79176524509', 'Ул Длинная дом', 61, 111222112, NULL);
